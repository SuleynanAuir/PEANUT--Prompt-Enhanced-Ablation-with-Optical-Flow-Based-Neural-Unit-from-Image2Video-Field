...
if ModulatedDeformConv2d is not None:
    # DCN available - use full implementation
    ...
    # DCN not available - use fallback with standard convolution
    import warnings
    warnings.warn("ModulatedDeformConv2d not available, using standard convolution fallback. "
                  "Performance will be degraded.")
    
    class SecondOrderDeformableAlignment(nn.Module):
        """Fallback version without deformable convolution."""
        ...
        def forward(self, x, extra_feat, flow_1, flow_2):
            # Ignore offset computation, just use standard conv
            return self.conv(x)
